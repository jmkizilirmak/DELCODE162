...
%% specify directories
SVM_dir = '\\dzne-go-csv\Schott-Lab\commons\162_DELCODE_Personality\SVM_PerAF\SVMs_same_subjs_CSFxtra_noADrel_no_DMN\'; % output directory
...
Xselect{7} = deal(X(:,1:13));              % confounding only (nullmodel)
